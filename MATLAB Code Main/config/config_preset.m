...
switch preset
    ...
    case 'CS_2ndorder_N1_3_irl'
        ...
        % terminating
        num_pol_iter = group_settings.istar;
...
%         tf = group_settings.tf;
        tf = 5;
        T = tf / (num_pol_iter * num_sims_per_iter * ...
                                    num_samples_per_sim);        
...
%         noise = group_settings.noise;
        ...
        % ICs for critic NN
        c_0 = group_settings.basis_actor_g_known.w0;
...
%         c_0 = [1; 1; 0];
        ...
        % ICs for actor NN
        w_0 = group_settings.basis_actor_g_known.w0;
...
%         w_0 = [-1 ; 1];  
    ...
    case 'comp_vrabie_lewis_2009_hard_vi'
        ...
        % Hamiltonian NN basis \Psi(x)
        Psi.tag = 'comp_vrabie_lewis_2009_hard_vi_psi';
...
%         c_0 = zeros(3,1);
    ...
    % *********************************************************************
    %
    % COMPARISON CART INVERTED PENDULUM -- IRL
    %
...
%         noise = group_settings.noise;
    ...
    % *********************************************************************
    %
    % COMPARISON CART INVERTED PENDULUM -- SPI
    %
...
%         tf = group_settings.tf;
    ...
    % *********************************************************************
    %
    % COMPARISON CART INVERTED PENDULUM -- RADP (MATCHED UNCERTAINTY)
    %        
        
    case 'comp_cip_radp_matched'
...
%         w_0 = [-1 ; 1];  
        ...
        % ICs for actor NN
        dmat_ic = group_settings.basis_actor_no_g.dmat_ic;
        c0_ic = group_settings.basis_actor_no_g.c0_ic;
        dmat = basis.Psi.dmat;
        w_0 = config_basis_ICs(dmat, dmat_ic, c0_ic);  
...
%         w_0 = 0 * ones(basis.Psi.N,1);
    ...
    % *********************************************************************
    %
    % COMPARISON CART INVERTED PENDULUM -- VI
    %
